...
######################################
#
# This algorithm is used to test things about building the map autonomously.
# Once it will be finished, it might be better to divide it in some different nodes: 
# 	1. Map creation
#	2. Find frontier / path planning
#
# To run it, it require the /map topic to be published.
#
#
